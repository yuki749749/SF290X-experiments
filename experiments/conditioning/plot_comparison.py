...
Expected folder structure (same as conditioning_ablation.yaml sweep output):
...
-----
    ...
    python plot_configurations.py --sweep_dir results/conditioning_ablation/sweep

    # Plot a specific timestamp:
    python plot_configurations.py \\
        --sweep_dir results/conditioning_ablation/sweep/2026-03-23_16-49-31
...
# Keys are folder names produced by Hydra overrides.
_CONFIG_ORDER = [
    "use_belief=False,use_return=False",
    "use_belief=False,use_return=True",
    "use_belief=True,use_return=False",
    "use_belief=True,use_return=True",
]

_CONFIG_LABELS = {
    "use_belief=False,use_return=False": "Unconditioned",
    "use_belief=False,use_return=True":  "Reward-only",
    "use_belief=True,use_return=False":  "Belief-only",
    "use_belief=True,use_return=True":   "Belief and Reward",
}


def config_label(pkl_path: Path) -> str:
    """Human-readable panel title derived from the Hydra override folder name."""
    name = pkl_path.parent.name          # e.g. "use_belief=True,use_return=False"
