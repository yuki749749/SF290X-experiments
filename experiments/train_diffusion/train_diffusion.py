...
def main(cfg: DictConfig) -> None:
    ...
    train_set = TrajectoryDataset(
        ...
        cfg.domain_pad,
        horizon=OmegaConf.select(cfg, "horizon", default=None),
        stride=OmegaConf.select(cfg, "stride", default=None),
        reward_key=OmegaConf.select(cfg, "reward_key", default=None),
        reward_type=OmegaConf.select(cfg, "reward_type", default=None),
